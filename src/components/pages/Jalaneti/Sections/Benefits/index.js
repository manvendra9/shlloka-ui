...
import ImageYogaBeneifits from "./Images/image-benefits.png";
    ...
    return (
        <div>
            ...
            <div style={{ position: "relative" }}>
                <img src={Wave} className="image-course-jalaneti-wave5" />
            </div>

            <section>
                <h2 className="text-center">Jalaneti Benefits</h2>
